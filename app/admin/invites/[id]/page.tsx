...
export default async function InviteAdminPage({
  ...
  async function save(formData: FormData) {
    ...
    await updateInvite(id, sessionUser.id, {
      ...
      dressCodeGroom: String(formData.get("dressCodeGroom") ?? "").trim() || null,
      dressCodeBride: String(formData.get("dressCodeBride") ?? "").trim() || null,
  ...
  const initial: InviteDraftValues = {
    ...
    dressCodeGroom: invite.dress_code_groom ?? "",
    dressCodeBride: invite.dress_code_bride ?? "",
